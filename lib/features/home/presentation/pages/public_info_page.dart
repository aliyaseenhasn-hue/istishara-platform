...
class PublicInfoPage extends StatelessWidget {
  ...
  static PublicInfoPage deleteAccount() => const PublicInfoPage(
    title: 'حذف حساب استشارة وبياناته',
    intro: 'يمكنك حذف حسابك نهائياً من داخل التطبيق، أو إرسال طلب حذف إلى فريق الدعم إذا تعذر عليك تسجيل الدخول.',
    sections: [
      ('الحذف من داخل التطبيق', 'سجّل الدخول، افتح صفحة الضبط، ثم اختر «حذف الحساب نهائياً» وأكّد الطلب. يبدأ تنفيذ الحذف فور التأكيد.'),
      ('الحذف عند تعذر الدخول', 'أرسل طلباً من البريد المرتبط بالحساب إلى support@astshara.iq، واكتب في العنوان «طلب حذف حساب». قد نطلب التحقق من ملكية الحساب قبل التنفيذ.'),
      ('البيانات التي تُحذف', 'تُحذف بيانات الحساب والملف الشخصي والبيانات التي لا يلزم الاحتفاظ بها لتقديم الخدمة أو الوفاء بالتزامات قانونية مشروعة.'),
      ('البيانات التي قد تُحفظ', 'قد نحتفظ لمدة لازمة بالسجلات المرتبطة بالحجوزات والمدفوعات والنزاعات أو مكافحة الاحتيال عندما يوجب القانون أو الغرض التشغيلي المشروع ذلك، ثم تُحذف أو تُخفى هويتها.'),
    ],
  );
